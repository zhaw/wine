...
detector{1} = sprintf('/home/zhaow/文档/bof/save_sift/ln_files/h_affine.ln -hesaff -i %s.ppm -o %s.reg -thres 5', tmpCode, tmpCode);
% 2) MAXIMALY STABLE REGION:
detector{2} = sprintf('/home/zhaow/文档/bof/save_sift/ln_files/mser.ln -per 1 -ms 30 -mm 5 -t 2 -i %s.ppm -o %s.reg', tmpCode, tmpCode);
...
status = unix(sprintf('/home/zhaow/文档/bof/save_sift/ln_files/compute_descriptors.ln -sift -noangle -i %s.ppm -p1 %s.feat -o %s.feat.sift', tmpCode, tmpCode, tmpCode));
