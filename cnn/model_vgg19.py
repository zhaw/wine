...
def get_model(input_size, ctx):
    ...
    style = mx.sym.Group([relu3_1, relu4_1])
#     tmp = mx.symbol.Pooling(data=relu4_1, kernel=(1,1), stride=(1,1), pool_type='max')
#     content = mx.sym.Group([tmp])
    content = mx.sym.Group([relu4_3])
